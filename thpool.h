...
typedef struct thpool_t {
    ...
    int              threadsN;                         /**< amount of threads        */
        sem_t            nStored;                        /**< semaphore(this is probably just holding the same as jobsN) */
    sem_t            nEmpty;                       /**< semaphore(this is indicate the number of free slot in jobQueue, we may assume jobsN equal threadsN) */
        sem_t            mutex;
